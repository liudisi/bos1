...
<textarea name="bug_c" id="bug_c" cols="50" rows="7" style=" border:solid 3px #E2E2E2;line-height:16px; padding:5px;resize: horizontal;"></textarea>
<br />
...
$('#bug_form').form({  
	url:"post.html",  
	onSubmit: function(){  
		if($.trim($('#bug_c').val()).length<1){
			$.messager.alert('Warning',"内容太少");	
			return false;
		}
	}, 
	success:function(data){  
		$.messager.alert('Success',"提交成功"); 
		$('#bug_c').val("");
	}  
});   
</script>